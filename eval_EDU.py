...
parser.add_argument("--model", type=str, default="dense_deep_edu_new", help="model path")
...
cuda = opt.cuda
save_path = os.path.join('val',opt.model)
...
for image_name in image_list:
    ...
    cv2.imwrite(os.path.join(save_path, "{}_IM_{}".format(opt.ep, filename)), im_output_forsave)
